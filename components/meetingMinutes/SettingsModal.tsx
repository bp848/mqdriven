        ...
        <div className="p-6 space-y-6">
          <div className="bg-blue-950/30 border border-blue-900/50 p-4 rounded-lg">
            ...
            <p className="text-xs text-blue-300/80 leading-relaxed">
              クラウド同期を有効にするにはSupabaseプロジェクト情報を入力してください。
              <br />
              <span className="font-semibold text-blue-200">必須カラム:</span>{' '}
              <code className="bg-blue-950 px-1 rounded">title</code>,{' '}
              <code className="bg-blue-950 px-1 rounded">summary</code>,{' '}
              <code className="bg-blue-950 px-1 rounded">transcript</code>,{' '}
              <code className="bg-blue-950 px-1 rounded">duration_seconds</code>,{' '}
              <code className="bg-blue-950 px-1 rounded">action_items (jsonb)</code>
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(event) => setTempConfig({ ...tempConfig, url: event.target.value })}
            ...
            <div>
              ...
              <input
                ...
                onChange={(event) => setTempConfig({ ...tempConfig, key: event.target.value })}
                placeholder="eyJ..."
                className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-brand-500 placeholder-slate-700"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(event) => setTempConfig({ ...tempConfig, tableName: event.target.value })}
          ...
          <div className="bg-slate-800/50 rounded-lg p-4 space-y-2">
            <h4 className="text-sm font-medium text-slate-300 flex items-center gap-2">
              <HelpCircle className="w-4 h-4 text-slate-400" /> 保存できない場合
            </h4>
