              ...
              {activeTab === 'summary' ? (
                <div className="prose prose-invert prose-sm max-w-none">
                   ...
                   {meeting.summary.split('\n').map((line, i) => {
                     ...
                     if (line.startsWith('- ')) return <li key={i} className="ml-4 list-disc text-slate-300 mb-1">{line.slice(2)}</li>;
            ...
            <div className="space-y-4">
              {meeting.actionItems.length === 0 ? (
                ...
                meeting.actionItems.map((item, idx) => (
                  <div key={idx} className="bg-slate-950/50 border border-slate-800 p-4 rounded-lg hover:border-brand-500/30 transition-colors group">
