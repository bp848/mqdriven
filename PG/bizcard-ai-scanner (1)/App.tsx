...
const SAMPLE_DATA: Customer[] = [
  {
    ...
    customer_contact_info: "alice.j@techinnovations.com",
    phone_number: "+1 (555) 123-4567",
    address_1: "123 Innovation Dr, San Francisco, CA",
    website_url: "www.techinnovations.com",
    created_at: "2023-10-25T10:00:00Z"
  },
  {
    id: "6ba7b810-9dad-11d1-80b4-00c04fd430c8",
    customer_name: "Global Solutions Ltd.",
    representative_name: "Bob Smith",
    note: "CTO",
    customer_contact_info: "bsmith@globalsolutions.com",
    phone_number: "+44 20 7946 0958",
    address_1: "456 Enterprise Way, London, UK",
    website_url: "www.globalsolutions.co.uk",
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {processing && (
          <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-500 mt-2">Mapping OCR entities to Supabase schema</p>
          </div>
        )}
          ...
          <div className="max-w-2xl mx-auto mt-12 animate-in zoom-in-95 duration-500">
             <div className="text-center mb-10">
                <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl mb-4">
                  Insert Business Cards to <br/>
                  <span className="text-indigo-600">Supabase DB</span>
                </h1>
                <p className="text-lg text-gray-600 max-w-lg mx-auto">
                  Upload a photo. Gemini will map the data to your <code>customers</code> table schema automatically.
                </p>
             </div>
            ...
            <label className="group relative flex flex-col items-center justify-center w-full h-80 border-2 border-dashed border-gray-300 rounded-3xl cursor-pointer hover:border-indigo-500 hover:bg-indigo-50/30 transition-all duration-300 bg-white shadow-sm">
              ...
              <div className="absolute bottom-6 flex gap-4 text-xs text-gray-400 font-medium">
                <span className="flex items-center gap-1"><Zap className="w-3 h-3"/> Auto-Map Columns</span>
                <span className="flex items-center gap-1"><Zap className="w-3 h-3"/> Schema Validation</span>
              </div>
            </label>
          </div>
        )}
