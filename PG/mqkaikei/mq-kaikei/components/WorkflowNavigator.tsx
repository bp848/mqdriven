          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-stretch relative">
                {/* Step 1 */}
                <button onClick={() => navigateTo('ocr')} className="flex-1 bg-slate-50 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 rounded-xl p-4 text-left transition group relative z-10">
                ...
                {/* Step 2 */}
                <button onClick={() => navigateTo('journal')} className="flex-1 bg-slate-50 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 rounded-xl p-4 text-left transition group relative z-10">
                  <div className="flex justify-between items-start mb-2">
                ...
                {/* Step 3 */}
                <button onClick={() => navigateTo('payables')} className="flex-1 bg-slate-50 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 rounded-xl p-4 text-left transition group relative z-10">
                  <div className="flex justify-between items-start mb-2">
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-stretch">
                 {/* Step 1 */}
                 <button onClick={() => navigateTo('receivables')} className="flex-1 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 rounded-xl p-4 text-left transition group">
                  <div className="flex justify-between items-start mb-2">
                ...
                {/* Step 2 */}
                <button onClick={() => navigateTo('ocr')} className="flex-1 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 rounded-xl p-4 text-left transition group">
                  <div className="flex justify-between items-start mb-2">
                ...
                {/* Step 3 */}
                <button onClick={() => navigateTo('cash_schedule')} className="flex-1 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 rounded-xl p-4 text-left transition group">
                  <div className="flex justify-between items-start mb-2">
        ...
        {activeTab === 'monthly' && (
           <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                 <button onClick={() => navigateTo('manufacturing')} className="bg-white border-2 border-slate-100 hover:border-emerald-500 rounded-xl p-4 text-left transition group">
                 ...
                 <button onClick={() => navigateTo('tax')} className="bg-white border-2 border-slate-100 hover:border-emerald-500 rounded-xl p-4 text-left transition group">
                    <div className="mb-2 p-2 bg-slate-100 w-fit rounded-lg group-hover:bg-emerald-100 transition">
                 ...
                 <button onClick={() => navigateTo('variance')} className="bg-white border-2 border-slate-100 hover:border-emerald-500 rounded-xl p-4 text-left transition group">
                    <div className="mb-2 p-2 bg-slate-100 w-fit rounded-lg group-hover:bg-emerald-100 transition">
                 ...
                 <button onClick={() => navigateTo('dashboard')} className="bg-white border-2 border-slate-100 hover:border-emerald-500 rounded-xl p-4 text-left transition group">
                    <div className="mb-2 p-2 bg-slate-100 w-fit rounded-lg group-hover:bg-emerald-100 transition">
