...
## 営業メールの明確な特徴
以下のいずれかに該当する場合は「営業メール」と判断してください：
- 「ご挨拶」「ご紹介」「ご提案」といった定型挨拶から始まる
- 自社サービスや製品の宣伝、セールスピッチが主目的
- 「貴社」「御社」への提案や提携話
- 相手の具体的なニーズや要望が全く記載されていない
- 「〜様」「〜様へ」という宛名が不明確
- メール内容が一般的で、どの企業にも送れるような内容
- 「〜させていただきます」「〜申し上げます」といった丁寧すぎる表現

## 印刷問い合わせの明確な特徴
以下のいずれかに該当する場合は「印刷問い合わせ」と判断してください：
- 具体的な印刷物名（チラシ、名刺、パンフレットなど）の記載
- サイズ（A4、B5など）、部数、ページ数の具体的な数字
- 納期や希望日時の記載
- 用紙の種類や仕様に関する質問
- 価格見積の依頼
- 過去の実績や既存製品についての問い合わせ

## 分析要件
1. **メール種別の判定**: 営業メールか印刷問い合わせかを厳密に判定
...
## 重要指示
- **営業メールと判断した場合**: 必ず「対応不要」と明記し、理由も簡潔に記載してください
- **印刷問い合わせと判断した場合**: 具体的な対応方針を提案してください
- **不明確な場合**: 「その他」とし、確認が必要であることを示してください
